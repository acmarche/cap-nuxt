<template>
  <div class="bigTriangle lg:col-start-1 lg:row-start-3 justify-self-start lg:self-end">
  </div>
  <div
      class="flex flex-row items-center justify-start gap-3 z-10 col-start-1 row-start-3 justify-self-start lg:self-end">
    <a href="/" class="">
...
.bigTriangle {
  ...
  opacity: 0.6;
  border-style: solid;
  border-color: transparent transparent transparent #4f8ea5;

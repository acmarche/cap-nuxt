...
<template>
    <section
        class="overflow-hidden w-full bg-green-400 bg-hero-pattern bg-bottom flex flex-col relative lg:grid lg:grid-cols-2 lg:grid-rows-[200px_200px_1fr] lg:justify-center lg:items-center lg:min-h-[45rem] ">
